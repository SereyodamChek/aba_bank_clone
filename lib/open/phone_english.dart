...
class PhoneEnglishScreen extends StatefulWidget {
  const PhoneEnglishScreen({super.key});

  @override
  State<PhoneEnglishScreen> createState() => _PhoneEnglishScreenState();
}

class _PhoneEnglishScreenState extends State<PhoneEnglishScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Description
                      Text(
                        'Please enter your phone number to verify with ABA system.',
                        style: GoogleFonts.dangrek(
                          color: Colors.white,
                          fontSize: 13,
                        ),
