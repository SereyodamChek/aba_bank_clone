...
class PhoneChineseScreen extends StatefulWidget {
  const PhoneChineseScreen({super.key});

  @override
  State<PhoneChineseScreen> createState() => _PhoneChineseScreenState();
}

class _PhoneChineseScreenState extends State<PhoneChineseScreen> {
