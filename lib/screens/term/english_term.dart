import 'package:aba_bank_clone/open/phone_english.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class EnglishTermScreen extends StatefulWidget {
  const EnglishTermScreen({super.key});

  @override
  State<EnglishTermScreen> createState() => _EnglishTermScreenState();
}

class _EnglishTermScreenState extends State<EnglishTermScreen> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Please read the terms below carefully before activating the ABA Mobile application.',
                        style: GoogleFonts.dangrek(
                          color: Colors.white,
                          fontSize: 14,
                          height: 1.6,
                      ...
                      const SizedBox(height: 10),
                      Text(
                        'By clicking "Agree", you confirm that you agree to comply with the terms of the ABA Mobile application.',
                        style: GoogleFonts.dangrek(
                          color: Colors.white,
                          fontSize: 14,
                          height: 1.6,
                      ...
                      Text(
                        'If you do not agree to these terms, please do not proceed or delete the ABA Mobile application.',
                        style: GoogleFonts.dangrek(
                          color: Colors.white,
                          fontSize: 14,
                          height: 1.6,
                      ...
                      _buildRadioButton(
                        index: 0,
                        text: 'I have an existing account, ABA Mobile Terms',
                        isLink: true,
                      ),
                      ...
                      _buildRadioButton(
                        index: 1,
                        text: 'I have an existing account, ABA Bank Services Terms of Use',
                        isLink: true,
                      ),
                      ...
                      _buildRadioButton(
                        index: 2,
                        text: 'I agree to all the above terms',
                        isLink: false,
                      ),
